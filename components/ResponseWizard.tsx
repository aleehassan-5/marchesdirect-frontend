      ...
      <div className="mt-6">
        {step === 0 && (
          <div className="flex flex-col gap-5">
            ...
            <div className="card p-5">
              <h3 className="font-display font-bold text-[15.5px] mb-3">{t("wiz_checklist_title")}</h3>
              <div className="flex flex-col gap-2">
                {requiredDocs.map((d) => (
                  <div key={d.name} className="flex items-center justify-between text-[14px] py-1.5">
                    <span>{isEn ? d.name_en : d.name}</span>
                    <span className={`text-[12px] font-mono font-semibold ${d.fromProfile ? "text-gold" : "text-ink-faint"}`}>
